...
class RustBackendMockHelper {
    ...
    private func setupDefaultMock(
        ...
        await rustBackendMock.setCreateToAddressUskToValueMemoUseZIP317FeesReturnValue(-1)
        await rustBackendMock.setShieldFundsUskMemoShieldingThresholdUseZIP317FeesReturnValue(-1)
